...
class DadosRepositorios:
    ...
    def __init__(self, owner):
        ...
        self.access_token='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'
...
ling_amz = amazon_rep.cria_df_linguagens()
    
netflix_rep = DadosRepositorios('netflix')
ling_netflix = netflix_rep.cria_df_linguagens()

spotify_rep = DadosRepositorios('spotify')
ling_spotify = spotify_rep.cria_df_linguagens()


#Salvando os dados

ling_amz.to_csv('dados/linguagens_amz.csv')

ling_spotify.to_csv('dados/linguagens_spotify.csv')

ling_netflix.to_csv('dados/linguagens_netflix.csv')